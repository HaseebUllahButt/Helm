...
await wait(3000);
console.log('agents:', await text(500));
// Devin
console.log('pick devin:', await clickText('devin'));
await wait(1500);
console.log('start:', await clickText('Start Devin'));
await wait(12000);
console.log('--- session ---'); console.log(await text(500));
await shot('m2.png');
