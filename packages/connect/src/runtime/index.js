/**
 * SessionRuntime — the contract con needs from whatever actually owns the
 * terminals.
 *
 * con itself knows nothing about herdr, tmux or PTYs; it knows it can create
 ...
 * that can do those things can back con.
 *
 ...
 *   capabilities.persistent  - sessions outlive the con daemon
 *
...
export async function createRuntime(kind = process.env.CON_RUNTIME || 'herdr', opts = {}) {
  if (kind === 'herdr') {
