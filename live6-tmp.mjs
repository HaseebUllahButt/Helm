...
// back out of the agent picker to the folder list, which re-lists on entry
await clickText('‹'); await wait(2500);
console.log('back:', await text(300));
console.log('pick folder:', await clickText('helm-image-check'));
await wait(2500);
console.log('after folder:', await text(300));
await shot('m1.png');
